  ...
  return (
    ...
    <section className='flex justify-between bg-gray-800 px-4 py-3'>
      <div className='relative' > 
        ...
        <input placeholder='هل تبحث عن شيء ما؟' className='bg-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 text-white rounded-lg w-80 pr-10  py-2'/>
      </div>

      <button className='inline-flex px-4 py-2 justify-center bg-gray-700 rounded-lg shadow hover:bg-gray-600 '>
        <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6 fill-current text-gray-500'   width="24" height="24" fill="none"><path fill="#A0AEC0" fill-rule="evenodd" d="M3 6a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1Zm3 6a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1Zm4 5a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-4Z" clip-rule="evenodd"/></svg>
        <span className='text-white mr-1 font-medium'>التصنيفات</span>
      </button>
    </section>
    <main>
      <h3>قرطبة</h3>
      <p>عش حياة الرفاهية في أفخم الفنادق على منتجعات البحر الأبيض المتوسط الساحرة</p>
    </main>
    </>
  )
}
